package com.turpgames.doubleup.server;
...
public class ServerConfig {
	...
	static {
		load("/com/turpgames/doubleup/server/doubleup.properties");
		String env = getEnvironment();
		if (!Util.Strings.isNullOrWhitespace(env))
			load(String.format("/com/turpgames/doubleup/server/doubleup-%s.properties", env));
	}
